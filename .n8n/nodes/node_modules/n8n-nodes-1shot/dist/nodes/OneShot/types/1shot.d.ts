...
export declare class PagedResponse<T> {
    ...
    pageSize: number;
    totalResults: number;
    constructor(response: T[], page: number, pageSize: number, totalResults: number);
}
export declare class ChainInfo {
    ...
    type: string;
    constructor(name: string, chainId: number, averageBlockMiningTime: number, nativeCurrency: NativeCurrencyInformation, type: string);
}
export declare class NativeCurrencyInformation {
    name: string;
    symbol: string;
    decimals: number;
